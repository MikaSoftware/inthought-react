        ...
        <div className="container-fluid">
            <div className="d-flex align-items-stretch">
                <main id="main" role="main">
                    ...
                    <div className="col-md-5 mx-auto mt-2" id="form_validations_errors">
                        <h3 className="pt-4 pb-2 text-center">Residential</h3>
                        <form id="residential-form" method="post" className="needs-validation" action="" >
                            <p className="border-bottom mb-3 pb-1 text-secondary">Personal Details</p>

                            <div id="all-errors" className="alert alert-error fade show error-block" role="alert">
                                <strong>There were errors during registration:</strong>

                                <div id="firstname-error" className="form-error">First name field is required.</div>
                                <div id="lastname-error" className="form-error">Last name field is required.</div>
                                <div id="phonenumber-error" className="form-error">Fill in valid 10 digits phone number.</div>
                                <div id="mobilenumber-error" className="form-error"></div>
                                <div id="email-error" className="form-error"></div>
                                <div id="ok-email-error" className="form-error">Ok to email: Please select option.</div>
                                <div id="ok-text-error" className="form-error">Ok to text: Please select option.</div>
                                <div id="dob-error" className="form-error">Please select Date of Birth.</div>
                                <div id="gender-error" className="form-error">Please select client Gender.</div>
