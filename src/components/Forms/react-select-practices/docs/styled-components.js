...
export const H1 = (props: any) => <h1 css={{ marginTop: 0 }} {...props} dangerouslySetInnerHTML={{ __html: '' }}/>;
export const H2 = (props: any) => <h2 css={{ marginTop: '2em' }} {...props} dangerouslySetInnerHTML={{ __html: '' }}/>;
